...
const WordCloud = ({ darkMode = true }) => {
  ...
  useInterval(() => {
    setCount(count > length - 1 ? 1 : count + 1);
    ...
    <Cloud txtColor={txtColor}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 170">
        ...
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-6" ? "blink" : ""}>
          node
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-7" ? "blink" : ""}>
          d3.js
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-8" ? "blink" : ""}>
          data viz
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-9" ? "blink" : ""}>
          accessiblity
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-10" ? "blink" : ""}>
          e-commerce
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-11" ? "blink" : ""}>
          jam stack
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-12" ? "blink" : ""}>
          next.js
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-13" ? "blink" : ""}>
          gatsby.js
        </animated.text>
        <animated.text
          ...
          fillOpacity=".8"
          fontFamily={`'BenchNine', sans-serif`}
          className={currentClass === "txt-14" ? "blink" : ""}>
          svg animations
        </animated.text>
      </svg>
    </Cloud>
